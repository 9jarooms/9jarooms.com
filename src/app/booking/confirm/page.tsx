...
export default function BookingConfirmPage() {
    return (
        <Suspense fallback={
            <main className="min-h-screen bg-gray-50 flex items-center justify-center p-3 md:p-8">
                <div className="bg-white rounded-3xl p-8 md:p-12 text-center shadow-lg border border-gray-100 flex flex-col items-center justify-center min-h-[300px] md:min-h-[400px] w-full max-w-xl">
                    <Loader2 className="w-8 h-8 md:w-9 md:h-9 text-green-600 animate-spin" />
                </div>
            </main>
        }>
    ...
    return (
        <main className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-3 sm:p-4 md:p-8">
            ...
            <div className="max-w-xl w-full mx-auto">
                    {status === 'loading' && (
                        <div className="bg-white rounded-3xl p-8 md:p-12 text-center shadow-lg border border-gray-100 flex flex-col items-center justify-center min-h-[300px] md:min-h-[400px]">
                            <div className="relative mb-6 md:mb-8">
                                <div className="absolute inset-0 bg-green-100 rounded-full blur-xl scale-150 animate-pulse"></div>
                                <div className="w-16 h-16 md:w-20 md:h-20 bg-green-50 rounded-full flex items-center justify-center relative z-10 mx-auto">
                                    <Loader2 className="w-8 h-8 md:w-9 md:h-9 text-green-600 animate-spin" />
                                </div>
                            </div>
                            <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">Confirming Payment</h2>
                            <p className="text-sm md:text-base text-gray-500 max-w-sm mx-auto">Please wait while we securely verify your payment with Paystack mapping to your booking...</p>
                        </div>
                    )}
                            ...
                            <div className="p-5 sm:p-6 md:p-8 space-y-6 md:space-y-8">
                                <div>
                                    ...
                                    <div className="bg-green-50 rounded-xl p-3 sm:p-4 border border-green-100">
                                        <h3 className="text-sm sm:text-base font-semibold text-green-900 mb-1 sm:mb-2">Check-in Instructions</h3>
                                        <p className="text-xs sm:text-sm text-green-800 leading-relaxed whitespace-pre-wrap">
                                ...
                                <div className="border-t border-gray-100 pt-6 sm:pt-8">
                                    ...
                                    <div className="space-y-3 sm:space-y-4">
                                        <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl bg-gray-50 border border-gray-100">
                                            ...
                                            <div>
                                                <p className="text-sm sm:text-base font-medium text-gray-900">{booking.property?.name}</p>
                                                <p className="text-xs sm:text-sm text-gray-500 mt-0.5">{booking.property?.address}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl bg-gray-50 border border-gray-100">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-[11px] sm:text-sm text-gray-500 mt-1 flex flex-col sm:flex-row sm:flex-wrap gap-x-4 gap-y-0.5 sm:gap-y-1">
                    ...
                    {(status === 'failed' || status === 'error') && (
                        <div className="bg-white rounded-3xl p-8 md:p-12 text-center shadow-lg border border-red-100 flex flex-col items-center justify-center min-h-[300px] md:min-h-[400px]">
                            <div className="w-16 h-16 md:w-20 md:h-20 bg-red-50 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6">
                            ...
                            <p className="text-sm md:text-base text-gray-500 mb-6 md:mb-8 max-w-sm mx-auto">{errorMsg}</p>
                            <Link href="/properties" className="bg-gray-900 text-white px-6 md:px-8 py-2.5 md:py-3 rounded-full text-sm md:text-base font-medium hover:bg-gray-800 transition-colors">
