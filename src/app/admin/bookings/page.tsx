                    ...
                    <table className="w-full text-sm min-w-[900px]">
                        <thead>
                            <tr className="text-left text-gray-500 border-b border-gray-100">
                                ...
                                <th className="px-5 py-3 font-medium whitespace-nowrap">Room</th>
                                <th className="px-5 py-3 font-medium whitespace-nowrap">Check-in</th>
                                <th className="px-5 py-3 font-medium whitespace-nowrap">Check-out</th>
                                <th className="px-5 py-3 font-medium whitespace-nowrap">Nights</th>
                                ...
                                <th className="px-5 py-3 font-medium whitespace-nowrap">Booked</th>
                            </tr>
                        </thead>
                        <tbody>
                            {bookings?.map((b: any) => (
                                <tr key={b.id} className="border-b border-gray-50 last:border-0 hover:bg-gray-50/50">
                                    ...
                                    <td className="px-5 py-3 text-gray-700 whitespace-nowrap">{b.property?.name}</td>
                                    <td className="px-5 py-3 text-gray-600 whitespace-nowrap">{b.room?.name}</td>
                                    <td className="px-5 py-3 text-gray-600 whitespace-nowrap">{b.check_in}</td>
                                    <td className="px-5 py-3 text-gray-600 whitespace-nowrap">{b.check_out}</td>
                                    <td className="px-5 py-3 text-gray-600 whitespace-nowrap">{b.nights}</td>
                                    <td className="px-5 py-3 font-semibold text-gray-900 whitespace-nowrap">₦{formatPrice(b.total_amount)}</td>
                                    <td className="px-5 py-3 whitespace-nowrap">
