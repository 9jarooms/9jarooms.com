                        ...
                        (() => {
                            ...
                            return (
                                <span className="text-sm font-semibold text-gray-900">
                                    ₦{min.toLocaleString()} – ₦{max.toLocaleString()} <span className="font-normal text-gray-400 text-xs">/ night</span>
                                </span>
                            );
                        })()
                    ) : (
                        <span className="text-sm font-semibold text-gray-900">
                            ₦{property.price_per_night?.toLocaleString()} <span className="font-normal text-gray-400 text-xs">/ night</span>
                        </span>
                    )}
                </div>
            </div>
